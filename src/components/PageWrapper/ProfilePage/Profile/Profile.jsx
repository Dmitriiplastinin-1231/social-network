    ...
    <article className="profile">
      {
        profile.bgPhoto ?
          <div className="profile__background">
            <img className='profile__background' src={baseURL + profile.bgPhoto} alt='profile background' />
            {props.isMyOwn &&
              <label className="profile__background-label">
                <input className="profile__background-input" type="file" onChange={saveBg} />
                Edit profile bg
              </label>
            }
      ...
      <div className='profile__inner'>
        <div className="profile__img-box">
          <img className='profile__img' src={profile.photo? baseURL + profile.photo : usetPhoto} alt='profilephoto' />
          {props.isMyOwn &&
        ...
        <div className='profile__descr'>
          ...
          <div className="profile__descr-left">
            <div className='profile__descr-inner'>
              <h2 className='profile__name'>{profile.name}
                {
                  profile.sex === 'man'
                    ?
                    <span>
              ...
              <Status statusText={profile.status} updateStatus={props.updateStatus} isMyOwn={props.isMyOwn} />
              {profile.age && <div className="profile__age">age: {profile.age}</div>}
          ...
          <div className="profile__descr-right">
            ...
            <NavLink className='profile__right-buttons' to={'../messages/' + profile.userId}>
